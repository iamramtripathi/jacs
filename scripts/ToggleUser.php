 ...
 * @since    1.0
 */
class ToggleUser extends JApplicationCli
{
	...
	public function doExecute()
	{
		...
		if(!$user->username == null)
		{
			...
			{
				$user->block = 1;
				$message = "The user with ID " . $id . " was blocked.";
			}
			else
			{
				$user->block = 0;
				$message = "The user with ID " . $id . " was unblocked.";
			}
...
JApplicationCli::getInstance('ToggleUser')->execute();